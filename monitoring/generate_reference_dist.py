...
from config import DATASET_FILE, FEATURE_COLUMNS, TRAINING_STATS
...
def generate_reference_distribution():
    ...
    for row in X_norm:
        ...
        # Softmax conversion if model outputs raw logits
    ...
    # Calculate frequency distribution across specified bins
